...
import com.epam.project.repository.specification.impl.ClientSelectByLoginSpecification;
...
public class RegistrationService {
    ...
    public static boolean isClientWithLoginExist(String login) {
        try {
            Specification specification = new ClientSelectByLoginSpecification(login);
