...
public class ParameterName {
    ...
    public static final String UPLOAD_DIR = "bike_image";
    ...
    public static final String INCORRECT_COST = "incorrectCost";
    public static final String INCORRECT_ADDRESS = "incorrectAddress";
    public static final String INCORRECT_DESCRIPTION = "incorrectDescription";
