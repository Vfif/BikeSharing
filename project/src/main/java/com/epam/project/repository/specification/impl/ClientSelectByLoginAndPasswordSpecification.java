...
public class ClientSelectByLoginAndPasswordSpecification implements Specification {
    private static final String SELECT_BY_LOGIN_AND_PASSWORD =
            "SELECT role, login, password, email, cash, status, bikeId  FROM client WHERE login=? AND password=?";
